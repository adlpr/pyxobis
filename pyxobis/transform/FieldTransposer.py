...
class FieldTransposer:
    ...
    def __add_hdgs_fields_from_bibs(self, db):
        ...
        for bib_ctrlno, bib_record in tqdm(db.get_bibs()):
            ...
            field_sets_to_move = (alt_id_fields, note_unknown_fields, note_serhold_fields, note_title_level_data_fields)
        ...
        for bib_ctrlno, bib_data in tqdm(bib_fields_to_move_map.items()):
            ...
            alt_id_fields, note_unknown_fields, note_serhold_fields, note_title_level_data_fields = field_sets_to_move
            ...
            for hdg_ctrlno in hdg_ctrlnos:
                ...
                # alt_id_fields : all alt ID fields ok for all associated hdgs
                self.map[hdg_ctrlno_prefixed].extend(alt_id_fields)
                # note_unknown_fields : ?????????
                ...
                ...
                ...
