...
class TimeBuilder(PrincipalElementBuilder):
    ...
    def set_calendar(self, link_title, role_URI, href_URI=None):
...
class DurationBuilder(PrincipalElementBuilder):
    ...
    #    MISSING: add_name, add_qualifier, set_type, set_role
    # ADDITIONAL: set_time_entry1, set_time_entry2,
    ...
    def set_calendar(self, link_title, role_URI, href_URI=None):
        ...
        self.set_calendar1(link_title, role_URI, href_URI)
        self.calendar2 = self.calendar1
    def set_calendar1(self, link_title, role_URI, href_URI=None):
    ...
    def set_calendar2(self, link_title, role_URI, href_URI=None):
...
class DurationVariantBuilder(PrincipalElementVariantBuilder):
    ...
    #             set_time_entry2, set_time_entry2_link,
    #             set_calendar, set_calendar1, set_calendar2
    def __init__(self):
        super().__init__()
